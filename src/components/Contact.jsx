...
const Contact = () => {
  return (
    <div className='border-b border-neutral-900 pb-20'>
        <motion.h2 whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: -100 }} transition={{ duration: 0.5 }} className='my-10 text-center text-4xl'>Contatos</motion.h2>
        <div className='text-center tracking-tighter'>
            ...
            <a href="mailto:talesknadev@gmail.com" className='border-b hover:text-emerald-400'>{CONTACT.email}</a>
        </div>
    </div>
  )
}
